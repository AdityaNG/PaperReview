...
- 🎯 Entry points to execute your program using `python -m <paperreview>` or `$ paperreview` with basic CLI argument parsing.
...
```py
from paperreview import BaseClass
from paperreview import base_function
